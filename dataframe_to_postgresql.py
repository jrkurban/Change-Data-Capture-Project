...
if __name__ == "__main__":
    ...
    ap.add_argument("-i", "--input", required=False, type=str, default="input/customers.csv",
                    help="Source data path. Default: ./input/customers.csv")
    ap.add_argument("-hst", "--host", required=False, type=str, default="localhost",
                    help="Default: localhost")
    ap.add_argument("-p", "--port", required=False, type=str, default="5433",
                    help="Default: 5433")
    ap.add_argument("-u", "--user", required=False, type=str, default="postgres",
                    help="Default: postgres")
    ap.add_argument("-psw", "--password", required=False, type=str, default="postgres",
                    help="Default: postgres")
    ap.add_argument("-db", "--database", required=False, type=str, default="postgres",
                    help="Default: postgres")
    ap.add_argument("-t", "--table", required=False, type=str, default="customers",
                    help="Default: customers")
    ...
    ap.add_argument("-b", "--batch_size", required=False, type=int, default=10,
                    help="Default: all_table")
    ap.add_argument("-pk", "--primary_key", required=False, type=str, default="customerId",
                    help="Default: customerId")
